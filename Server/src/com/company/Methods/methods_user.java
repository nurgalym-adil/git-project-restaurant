...
public class methods_user implements Standard_methods {
    ...
    public String getUserOrders(String handle) {
        ...
        int t = 1;
        ArrayList<BookingTables>bookingTables = dataBase.GetAllBookingTablesThisUser(handle);
        ArrayList<FoodDelivery>foodDeliveries = dataBase.GetAllFoodDeliveryThisUser(handle);
